package tests.org.elsys.gallery;
...
import org.elsys.gallery.Gallery;
import org.elsys.gallery.Sculpture;
...
public class GalleryTest {
    ...
    public void testAddForgery() {
        ...
        gallery.add(new Sculpture("A", "T", 1, 2, 2));
    }

    @Test
    public void testContains() {
        assertTrue(gallery.add(new Sculpture("A", "T", 1, 2, 1)));
        assertFalse(gallery.contains(new Sculpture("A", "T", 2, 2, 3)));
